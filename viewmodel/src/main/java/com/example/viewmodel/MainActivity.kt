...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Dès que le compteur change, j'effectue les actions dans l'Observer avec "it" comme nouvelle valeur
        vm.compteur.observe(this, Observer {
            binding.textViewCompteur.text = it?.toString()
        })

        // TODO Lorsque le bouton est appuyé, incrémenter le compteur depuis le VM  et afficher le compteur
